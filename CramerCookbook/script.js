...
function init() {
    ...
    notes = JSON.parse(localStorage.getItem('CramerNotes')) || {};
...
function showRecipe(id) {
    ...
    var favs = JSON.parse(localStorage.getItem("CramerFavorites")) || [];
    if(favs.includes(id)) {
...
function toggleFavorite() {
    ...
    localStorage.setItem('CramerFavorites', JSON.stringify(favs))
...
function saveNote() {  
    ...
    localStorage.setItem('CramerNotes', JSON.stringify(notes));
